...
////////////////////////////////////////////
    ...
    if (this.selectedTags)
    {
     ...
     this.emeraldNameArray = ['Emerald Hill Reservoir Level','Emerald Hill Flow Rate', 'Emerald Hill Total Flow']
     this.emeraldData = [this.variable.EMER_H_Level_arr,this.variable.EMER_H_Flow_Rate_arr,this.variable.EMER_H_Total_Flow_arr,]
     this.emeraldAxis = [axisValues.EMER_H_LEVEL_axis,axisValues.EMER_H_FLOW_RATE_axis,axisValues.EMER_H_TOTAL_FLOW_axis ]

     const emer = new TrendV2(this.emeraldNameArray,this.emeraldData,this.emeraldAxis)

     console.log(emer.getSeries())
    ...
    },
{
  ...
  {//Humansdorp
    ...
    },
    {
      ...
      showSymbol: false,
      hoverAnimation: true,
      data: this.variable.para_flow_rate_arr ,
      smooth: true,
      yAxisIndex:axisValues.para_flow_rate_axis
    },
    {
      ...
      showSymbol: false,
      hoverAnimation: true,
      data: this.variable.para_total_flow_arr ,
      smooth: true,
      yAxisIndex:axisValues.para_total_flow_axis
    },
    {
      ...
      showSymbol: false,
      hoverAnimation: true,
      data: this.variable.para_st_flow_rate_arr ,
      smooth: true,
      yAxisIndex:axisValues.para_st_flow_rate_axis
    },
    {
      ...
      showSymbol: false,
      hoverAnimation: true,
      data: this.variable.para_st_total_flow_arr ,
      smooth: true,
      yAxisIndex:axisValues.para_st_total_flow_axis
    },
