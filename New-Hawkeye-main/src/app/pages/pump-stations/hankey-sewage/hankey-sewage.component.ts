...
export class HankeySewageComponent implements OnInit {
  ...
  hank_ps_g_bat_level_ok: {
    value: null,
     alarm:"Fault",
     alarmTrip: 1,
     description:"Battery Level Not OK"
  },
  ...
  intervalLoop: any
  ngOnInit(): void {
    // this.intervalLoop = this.pm.findPageDataForNewSites("motherwell_new", "PS_CurrentVals").subscribe((result) => {
    ...
    //     rowType:"TextRow",
    //     label:"Speed",
    //     value:this.variable.hank_ps_p1_speed
    //   },{
    //     rowType:"TextRow",
    //     label:"Num Of Starts",
    ...
    //     rowType:"TextRow",
    //     label:"Run Hours",
    //     value:this.variable.hank_ps_p1_run_hours
    //   }]
    ...
    //     rowType:"TextRow",
    //     label:"Speed",
    //     value:this.variable.hank_ps_p2_speed
    //   },{
    //     rowType:"TextRow",
    //     label:"Num Of Starts",
    ...
    //     rowType:"TextRow",
    //     label:"Run Hours",
    //     value:this.variable.hank_ps_p2_run_hours
    //   }]
    ...
    //     rowType:"TextRow",
    //     label:"Speed",
    //     value:this.variable.hank_ps_p3_speed
    //   },{
    //     rowType:"TextRow",
    //     label:"Num Of Starts",
    ...
    //     rowType:"TextRow",
    //     label:"Run Hours",
    //     value:this.variable.hank_ps_p3_run_hours
    //   }]
    //   Common.getFaultRouteDatas(this.faultArr,this.faultVariable,this.variable)
    //   var alarmG: any [] = [this.faultVariable.hank_ps_g_voltage_present,this.faultVariable.hank_ps_g_surge_arrestor_fault,this.faultVariable.hank_ps_g_bat_level_ok,this.faultVariable.hank_ps_g_power_meter_comms_fail,this.faultVariable.hank_ps_g_sump_level_analog_fail]
    //   var alarm1: any [] = [this.faultVariable.hank_ps_p1_vsd_fault,this.faultVariable.hank_ps_p1_no_flow,this.faultVariable.hank_ps_p1_e_stop,this.faultVariable.hank_ps_p1_circuit_breaker_tripped,this.faultVariable.hank_ps_p1_startup_failure,this.faultVariable.hank_ps_p1_vsd_analog_fail]
    //   var alarm2: any [] = [this.faultVariable.hank_ps_p2_vsd_fault,this.faultVariable.hank_ps_p2_no_flow,this.faultVariable.hank_ps_p2_e_stop,this.faultVariable.hank_ps_p2_circuit_breaker_tripped,this.faultVariable.hank_ps_p2_startup_failure,this.faultVariable.hank_ps_p2_vsd_analog_fail]
    //   var alarm3: any [] = [this.faultVariable.hank_ps_p3_vsd_fault,this.faultVariable.hank_ps_p3_no_flow,this.faultVariable.hank_ps_p3_e_stop,this.faultVariable.hank_ps_p3_circuit_breaker_tripped,this.faultVariable.hank_ps_p3_startup_failure,this.faultVariable.hank_ps_p3_vsd_analog_fail]
...
options2:EChartsOption
  ...
  pumpColor1:any = "#FF0000"
pumpColor2:any = this.pumpColor1
pumpColor3:any = this.pumpColor1;
dataSourceG:any;
dataSourceP1:any;
dataSourceP2:any;
dataSourceP3:any;
