...
var trend: any = {};
  this.rs.Get_HUP3_TotalFlows().subscribe(data => {
    trend=data
    this.total_flow_HD3_array = trend.total_flow_HD3_array;
  ...
  this.rs.Get_HUP3_Total_Flows_Dates(newStart, newEnd).subscribe(data => {
  trend=data
